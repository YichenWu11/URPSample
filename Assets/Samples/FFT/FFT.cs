...
public class FFT : IDisposable
{
    ...
    {
        (fftTextureTmp_, fftTextureOut_) = (fftTextureOut_, fftTextureTmp_);
    }
    ...
    public void DispatchFFTU(FFTType fftType, int radix, int p, Texture fftTextureIn, RenderTexture fftTextureOut)
    {
        ...
        {
            case 2:
                ditKernel = fftType == FFTType.DFT ? KERNEL_DIT_X : KERNEL_DIT_X_IDFT;
                break;
            case 4:
                ditKernel = fftType == FFTType.DFT ? KERNEL_DIT4_X : KERNEL_DIT4_X_IDFT;
                break;
            case 8:
                ditKernel = fftType == FFTType.DFT ? KERNEL_DIT8_X : KERNEL_DIT8_X_IDFT;
                break;
            case 16:
                ditKernel = fftType == FFTType.DFT ? KERNEL_DIT16_X : KERNEL_DIT16_X_IDFT;
                break;
            case 32:
                ditKernel = fftType == FFTType.DFT ? KERNEL_DIT32_X : KERNEL_DIT32_X_IDFT;
                break;
            case 64:
                ditKernel = fftType == FFTType.DFT ? KERNEL_DIT64_X : KERNEL_DIT64_X_IDFT;
                break;
            case 128:
                ditKernel = fftType == FFTType.DFT ? KERNEL_DIT128_X : KERNEL_DIT128_X_IDFT;
                break;
            case 256:
                ditKernel = fftType == FFTType.DFT ? KERNEL_DIT256_X : KERNEL_DIT256_X_IDFT;
                break;
            case 512:
                ditKernel = fftType == FFTType.DFT ? KERNEL_DIT512_X : KERNEL_DIT512_X_IDFT;
                break;
            case 1024:
                ditKernel = fftType == FFTType.DFT ? KERNEL_DIT1024_X : KERNEL_DIT1024_X_IDFT;
                break;
        }
    ...
    public void DispatchFFTV(FFTType fftType, int radix, int p, Texture fftTextureIn, RenderTexture fftTextureOut)
    {
        ...
        {
            case 2:
                ditKernel = fftType == FFTType.DFT ? KERNEL_DIT_Y : KERNEL_DIT_Y_IDFT;
                break;
            case 4:
                ditKernel = fftType == FFTType.DFT ? KERNEL_DIT4_Y : KERNEL_DIT4_Y_IDFT;
                break;
            case 8:
                ditKernel = fftType == FFTType.DFT ? KERNEL_DIT8_Y : KERNEL_DIT8_Y_IDFT;
                break;
            case 16:
                ditKernel = fftType == FFTType.DFT ? KERNEL_DIT16_Y : KERNEL_DIT16_Y_IDFT;
                break;
            case 32:
                ditKernel = fftType == FFTType.DFT ? KERNEL_DIT32_Y : KERNEL_DIT32_Y_IDFT;
                break;
            case 64:
                ditKernel = fftType == FFTType.DFT ? KERNEL_DIT64_Y : KERNEL_DIT64_Y_IDFT;
                break;
            case 128:
                ditKernel = fftType == FFTType.DFT ? KERNEL_DIT128_Y : KERNEL_DIT128_Y_IDFT;
                break;
            case 256:
                ditKernel = fftType == FFTType.DFT ? KERNEL_DIT256_Y : KERNEL_DIT256_Y_IDFT;
                break;
            case 512:
                ditKernel = fftType == FFTType.DFT ? KERNEL_DIT512_Y : KERNEL_DIT512_Y_IDFT;
                break;
            case 1024:
                ditKernel = fftType == FFTType.DFT ? KERNEL_DIT1024_Y : KERNEL_DIT1024_Y_IDFT;
                break;
        }
